...
<?php  
    ...
    $nro_reg= mysqli_num_rows($consulta);
            ...
            if($nro_reg==0){
                echo 'No se tienen productos registrados';
            }
    //$reg_por_pagina=4;  
    //@$nro_pagina=$_GET['num'];
    ...
    //$consulta= mysqli_query($conexion,"select * from productos limit $inicio,$reg_por_pagina");    
...
<html> 
    ...
    <div class="contenedor">
            <?php 
                ...
                <div class="caja">
                    ...
                    <form class="Caja_Boton" action="Productos_Detalles.php" method="post" name="detalle">
                        <input name="id" type="hidden" value="<?php echo $id ?>"/>
                        <input class="Boton_Detalles" type="submit" value="Detalles">
                    </form>
                </div>
                <?php
            }
    ...
    <div align="center" class="Paginacion">          
        ...
        <ul class="pagination">
        //<?php       
        //echo "<h3> Pagina Nº: ".$nro_pagina."</h3><br><br>"; 
        //if ($nro_pagina > 1) {
        //    echo "<li><a href='Productos.php?num=" . ($nro_pagina - 1) . "'>Anterior </a></li>";
        //}
        
        //for($i=1;$i<=$can_paginas;$i++){
        //    if ($i == $nro_pagina) {                
        //        echo "<li><a href='Productos.php?num=$i'> $i </a></li>";
        //    } else {
        //        echo "<li><a href='Productos.php?num=$i'> $i </a></li>";
        //    }
        //}
        ...
        //    echo "<li><a href='Productos.php?num=" . ($nro_pagina + 1) . "'> Siguiente</a></li>";
        //}
        //?>
        </ul>    
    </div> 
